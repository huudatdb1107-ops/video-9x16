...
1. Khi Boss gõ trigger → hỏi 2 thông tin:
   ...
   > Khi tạo video cho Brand `vicon` (KID/BOOM BOOM), AI **bắt buộc** phải tự động viết kịch bản (nếu chỉ có chủ đề) hoặc kiểm duyệt tối ưu kịch bản theo đúng chỉ dẫn của [master_prompt_kid.md](file:///e:/HuuDat/BrianD/TOOL_BrianD/.agent/skills/video-9x16/references/master_prompt_kid.md).
   > Kịch bản phải dài ~187 từ, chia 5 phần (Hook, Khoa học, 3 Điểm dạng Một/Hai/Ba, Câu thấu cảm in nghiêng, và CTA chuẩn cố định: *"Theo dõi kênh để không đi một mình — hàng ngàn cha mẹ đang đồng hành cùng con trên hành trình này."*)
